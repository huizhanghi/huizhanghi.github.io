...
const portfolioItems = [
    ...
    {
        title: "医疗书本知识对话",
        description: "该医学问答系统基于RAG架构，支持PDF/Word文档的语义解析与答案生成。采用分层文本分块技术，结合千问和OpenAI嵌入模型构建向量表征，通过Elasticsearch实现混合检索架构。利用特征加权融合和语义-术语协同检索优化文档匹配，动态重排序机制提升准确率。系统整合上下文感知生成模型，实现毫秒级响应与逻辑连贯的回答输出，适用于企业知识库和智能客服场景，兼顾检索速度与医学专业性。",
        images: ["images/搜表.png", "images/搜图.png"]
    },
    {
        title: "文本对比评分",
        description: "本项目构建了基于Qwen2.5大模型的智能问答系统，通过AutoDL云平台实现低成本高效训练。针对72B模型硬件需求过高问题，创新采用7B模型结合LoRA轻量化微调技术，配合SWIFT框架将训练周期压缩40%，并集成vLLM推理加速引擎实现3倍响应提升。开发过程中突破敏感词过滤机制，通过白名单策略保障专业领域术语完整性。本地化部署。关键技术涉及轻量化训练架构、推理加速优化、云端资源动态调度等方向，为垂直领域大模型落地提供高性价比解决方案。",
        image: "images/评分.png"
    }
];
